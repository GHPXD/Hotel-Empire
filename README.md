...
Estado: **M0–M5**, validados: construção, simulação, gestão, progressão e conteúdo inicial. Protótipo, ainda sem arte final
...
sete suítes headless e cinco testes gráficos. Passe `-GodotPath` para outro engine.
